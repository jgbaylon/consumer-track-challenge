...
class QaAutomationAssessment(unittest.TestCase):
...
# TESTS
    ...
    def test_pixel_fired(self):
        ...
        self.go_to_link(driver)
        self.fill_out_page_1(driver)
        self.fill_out_page_2(driver)
        self.fix_full_ssn(driver)
        self.submit_verify_identity_page(driver)
        self.fill_out_final_page(driver)
        self.verify_pixel_fired(driver)

# HELPER FUNCTIONS

    def go_to_link(self, driver):
    ...
    def fill_out_page_1(self, driver):
        ...
        self.submit_page(driver)

    def fill_out_page_2(self, driver):
        ...
        phone1.click() # necessary for jquery to put cursor to correct position
    ...
    def verify_pixel_fired(self, driver):
